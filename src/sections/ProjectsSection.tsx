  ...
  return (
    <section id="projects" className="section bg-gray-50">
      <div className="container-narrow">
        <p className="text-sm text-gold font-medium mb-4">Loyihalar</p>
        ...
        <div className="space-y-6">
          {projects.map((project, index) => (
            <div
              key={project.title}
              className="p-6 bg-white border-l-4 border-gold hover:bg-gray-50 transition-colors"
            >
              <div className="flex flex-wrap items-start justify-between gap-4 mb-3">
                <h3 className="text-xl font-medium text-gold">{project.title}</h3>
                <span className="text-sm text-gold font-medium">0{index + 1}</span>
              </div>
